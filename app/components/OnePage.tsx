			...
			<div className="px-6 md:px-10 lg:px-16 xl:px-32 pt-32 flex flex-col lg:flex-row justify-between">
				<div className="lg:w-5/12">
					...
					<section className="animation">
						<div className="first">
							<h2 className="leading-none dark:text-[#e7e6e2]">Creative Designer</h2>
						</div>
						<div className="second">
							<h2 className="leading-none dark:text-[#e7e6e2]"> Web Developer </h2>
						</div>
						<div className="third">
							<h2 className="leading-none dark:text-[#e7e6e2]">Passionate Crafter</h2>
						</div>
					</section>
				</div>
				<div className="md:w-6/12 pt-10 lg:pl-10 flex flex-col gap-10 justify-center items-start">
