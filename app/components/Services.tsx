...
export default async function Services() {
	...
	return (
		<div className="px-32 pt-32 flex gap-8">
			{data.data.map((feature, index) => (
				<div className="service w-4/12 p-10 flex flex-col" key={feature.id}>
					<FontAwesomeIcon className="my-icon pb-5" icon={require("@fortawesome/free-solid-svg-icons")[feature.attributes.icon]} />

					<div className=" text-center">
						<h3 className={yeseva.className}>{feature.attributes.title}</h3>
